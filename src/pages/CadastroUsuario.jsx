      ...
      <div className="bg-surface-container-lowest p-6 rounded-2xl border border-outline-variant/20 shadow-sm space-y-4">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-1 mb-2 relative border-l-2 border-primary/20 pl-4">
              ...
              <input required type="email" placeholder="digite um email" value={form.email} onChange={e => setForm({...form, email: e.target.value.toLowerCase().trim()})} className="p-3 bg-white dark:bg-slate-800 border-2 border-primary/40 rounded-lg focus:ring-2 focus:ring-primary outline-none font-mono text-sm shadow-md" />
